 ...
 */
function il10_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'il10_content_width', 640 );
}
add_action( 'after_setup_theme', 'il10_content_width', 0 );
 ...
 */
function il10_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'il10' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function il10_scripts() {
	...
	wp_enqueue_script( 'il10-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'il10_scripts' );
